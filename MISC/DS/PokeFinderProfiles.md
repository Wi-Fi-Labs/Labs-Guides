...
Start by opening FinderToolbox (or whatever other PF v3 build/fork you have). Navigate to `Tools>Settings>Profiles Path` and click `change`; you can now create a new `profiles.json` file that you can name whatever you wish (example: `profiles_toolbox.json`). You can reference the image below for better visualization.<br>
![](https://raw.githubusercontent.com/Wi-Fi-Labs/Labs-Guides/main/MISC/Images/PokeFinderProfiles1.png)
