...
Pick one of the results the tool above gives you and note the target 'frame' or advancement to hit; usually you would pick the earliest one, unless you'd like a specific SID that makes your spread Square Shiny - If you want to know if any of the results will yield a Square Shiny combo, you can check the values with [Lego's 'SID-For-Shiny' Tool](https://legofigure11.github.io/tools/sid-for-shiny/).<br>
